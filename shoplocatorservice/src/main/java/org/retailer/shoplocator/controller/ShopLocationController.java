...
/**
 * Spring Controller which acts as the entry point for Shop Locator Micro Service. 
...
public class ShopLocationController {
	...
	/**
	 * Controller method to query nearest shop while providing latitude and longitude in the url.
	 * @param latitude
	 * @param longitude
	 * @return
	 * @throws Exception
	...
	/**
	 * Controller method to add a Shop Location.
	 * @param AddShopLocationRequestTO
	 * @return
	 * @throws Exception
	 */
