...
public class ShopLocationServiceImpl implements ShopLocationService
{
    ...
    /**
     * Creates a new Shop Location. It obtains latitude and longitude from shop postal address using Google API and creates
     * a new shop location with this details and shop id.
